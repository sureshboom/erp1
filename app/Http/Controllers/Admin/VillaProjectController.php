...
class VillaProjectController extends Controller
{
    ...
    {
      $villaprojects = VillaProject::where('id',$id)->with('siteengineer:id,user_id,user_code,phone,photo,location','chiefengineer:id,user_id,user_code,phone,photo','siteengineer.user:id,name,role','chiefengineer.user:id,name,role','villas','materialin','materialhistory:id,villa_project_id,meterial_id,quantity,transfor_in,transfor_out','materialhistory.material:id,meterial_name,unit','materialhistory.transforout')->get();
