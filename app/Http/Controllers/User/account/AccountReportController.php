...
class AccountReportController extends Controller
{
    ...
    public function salaryreport(Request $request)
    {
        ...
        // return $salarys;
        return view('user.account.reports.salary',compact('users','salarys'));
    ...
    public function income(Request $request)
    {
        ...
        return view('user.account.reports.income',compact('payments'));
    }
    ...
    public function supplier(Request $request)
    {
        ...
        return view('user.account.reports.supplier',compact('payments','suppliers'));
    }
    ...
    public function lsupplier(Request $request)
    {
        ...
        return view('user.account.reports.laboursupplier',compact('payments','suppliers'));
    }
