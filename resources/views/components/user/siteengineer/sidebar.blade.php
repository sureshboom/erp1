...
<li>
    ...
    <ul class="submenu-angle" aria-expanded="true">
        <li><a title="owner" href="#"><span class="mini-sub-pro">Create Meshthri</span></a></li>
        <li><a title="sites" href="#"><span class="mini-sub-pro">Meshthri Assign</span></a></li>
    </ul>
</li>
...
<li>
    ...
    <ul class="submenu-angle" aria-expanded="true">
        ...
        <li><a title="sites" href="#"><span class="mini-sub-pro">Material Request</span></a></li>
