            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="{{ ((request()->routeIs('salaryreport')) || (request()->routeIs('expensereport')) || (request()->routeIs('landprojectreport')) || (request()->routeIs('contractprojectreport')) || (request()->routeIs('villaprojectreport')) || (request()->routeIs('income')) || (request()->routeIs('supplierreport')) || (request()->routeIs('lsupplierreport'))) ? 'active' : '' }}">
                            <a class="has-arrow" href="#">
                               <span class="educate-icon educate-form icon-wrap"></span>
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li class="{{(request()->routeIs('income')) ? 'active' : '' }}"><a title="owner" href="{{ route('income')}}"><span class="mini-sub-pro">Income Reports</span></a></li>
                                <li class="{{(request()->routeIs('supplierreport')) ? 'active' : '' }}"><a title="owner" href="{{ route('supplierreport')}}"><span class="mini-sub-pro">Supplier Reports</span></a></li>
                                <li class="{{(request()->routeIs('lsupplierreport')) ? 'active' : '' }}"><a title="owner" href="{{ route('lsupplierreport')}}"><span class="mini-sub-pro">Labour Reports</span></a></li>
