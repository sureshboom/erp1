            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="{{ ((request()->routeIs('salaryreport')) || (request()->routeIs('expensereport')) || (request()->routeIs('landprojectreport')) || (request()->routeIs('contractprojectreport')) || (request()->routeIs('villaprojectreport')) || (request()->routeIs('income')) || (request()->routeIs('supplierreport'))) ? 'active' : '' }}">
                            <a class="has-arrow" href="#">
                               <span class="educate-icon educate-form icon-wrap"></span>
