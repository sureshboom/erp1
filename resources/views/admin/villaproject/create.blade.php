        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form action="{{ route('villaproject.store') }}" class="acount-infor" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="no_of_unit" type="text" class="form-control" placeholder="No of Units" value="{{ old('no_of_unit') }}">
                                @error('no_of_unit')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
