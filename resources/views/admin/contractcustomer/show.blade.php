                                ...
                                <div class="profile-info-inner">
                                    ...
                                    <div class="profile-details-hr">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                <div class="address-hr ">
                                                    <p><b class="text-primary">ID</b><br /> {{$customer->skscc_id}}</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                <div class="address-hr">
                                                    ...
                                                    <p><b class="text-primary">Project Name</b><br /> {{$customer->contractproject->project_name}}</p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                <div class="address-hr ">
                                                    <p><b class="text-primary">Project ID</b><br /> {{$customer->contractproject->skscp_id}}</p>
                                                </div>
                                            </div>
                                        </div>
