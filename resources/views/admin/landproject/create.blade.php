        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form action="{{ route('landproject.store') }}" class="acount-infor" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input name="total_area" type="text" class="form-control" placeholder="Total Area" value="{{ old('total_area') }}">
                                @error('total_area')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input name="no_plots" type="text" class="form-control" placeholder="No of Plots" value="{{ old('no_plots') }}">
                                @error('no_plots')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
