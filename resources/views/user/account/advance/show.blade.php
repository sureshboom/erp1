                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="datatable-ct">
                                                    ...
                                                    <a href="#" class="btn btn-link btn-danger" onclick="document.getElementById('delete-post-{{ $advance->id }}').submit();"><i class="fa fa-trash"></i></a>
                                                    <form method="post" action="{{ route('account.advance.destroy', $advance->id) }}" id="delete-post-{{ $advance->id }}" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </td>
