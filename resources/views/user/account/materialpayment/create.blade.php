        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form action="{{ route('account.material_payment.store') }}" class="acount-infor" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label>Order </label>
                                <select name="materialins_id" id="materialins_id" class="form-control">
                                        <option value="">Select Order</option>
                                        @foreach($materialins as $materialin)
                                        <option value="{{$materialin->id}}">SKSOR {{$materialin->id}}</option>
                                        @endforeach
                                </select>
                                @error('site_id')
