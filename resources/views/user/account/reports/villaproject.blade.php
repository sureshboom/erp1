                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Villa</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>Villa Project <span class="table-project-n">Details</span> Table</h1>

                                <form class="form-inline" action="{{route('account.villaprojectreport')}}" method="GET">
                                    @csrf
                                    @method('GET')
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <a href="{{route('account.villaprojectreport')}}" class="btn btn-danger">Reset</a>
                                        </div>
                                    </div>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p>Project Name : <span>{{ $payment->villaproject->project_name ? $payment->villaproject->project_name : '' }}</span></p>
                                                <p>Customer Name : <span>{{ $payment->villacustomer->customer_name ? $payment->villacustomer->customer_name : '' }}</span></p>
