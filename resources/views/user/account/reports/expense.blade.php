                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                ...
                                <form class="form-inline" action="{{route('account.expensereport')}}" method="GET">
                                    @csrf
                                    @method('GET')
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <a href="{{route('account.expensereport')}}" class="btn btn-danger">Reset</a>
                                        </div>
                                    </div>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    @switch($expense->expense_project_type)
                                                        ...
                                                        @break;
                                                        @case('contract')
                                                            <p>Contract Project : <span>{{ $expense->contractproject->project_name ? $expense->contractproject->project_name : '' }}
                                                                </span></p>
                                                        @break;
                                                        @case('villa')
                                                            <p>Villa Project : <span>{{ $expense->villaproject->project_name ? $expense->villaproject->project_name : '' }}
                                                                </span></p>
                                                        @break;
                                                        @default
                                                        <p></p>
