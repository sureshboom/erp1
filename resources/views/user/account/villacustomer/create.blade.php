                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Create Villa Customer</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form action="{{ route('account.villacustomer.store') }}" class="acount-infor" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <select name="project_id" class="form-control">
                                        ...
                                        <option value="{{$villaproject->id}}">{{$villaproject->project_name}} ({{$villaproject->sksvp_id}})</option>
                                        @endforeach
                                </select>
                                @error('project_id')
                                    <div class="text-danger">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="vilano" type="text" value="{{ old('vilano') }}" class="form-control" placeholder="Villa No">
                                @error('vilano')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input name="villa_area" type="text" value="{{ old('villa_area') }}" class="form-control" placeholder="Villa Area">
                                @error('villa_area')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
