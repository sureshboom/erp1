                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            ...
                            <a href="{{ route('account.site_payment.index')}}" class="btn btn-danger">Back</a>
                        </div>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $history->site->sitename ? $history->site->sitename : '' }}</td>
                                            ...
                                            <td class="datatable-ct">
                                                ...
                                                <a href="{{ route('account.site_payment.edit', $history->id) }}"
                                                    class="btn btn-link">
                                                ...
                                                <form method="post" action="{{ route('account.site_payment.destroy', $history->id) }}" id="delete-post-{{ $history->id }}" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
