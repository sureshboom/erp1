                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Create Contract Customer</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form action="{{ route('account.contractcustomer.store') }}" class="acount-infor" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <select name="project_id" class="form-control">
                                        ...
                                        <option value="{{$contractproject->id}}">{{$contractproject->project_name}} ({{$contractproject->skscp_id}})</option>
                                        @endforeach
                                </select>
                                @error('project_id')
                                    <div class="text-danger">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                <label>Finalised Total Amount</label>
