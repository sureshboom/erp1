                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                ...
                                <form class="form-inline" action="{{route('telecaller.teleworkreport')}}" method="GET">
                                    @csrf
                                    @method('GET')
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input name="from_date" type="date"  class="form-control" placeholder="No of Called" value="{{ old('from_date') }}" required>
                                                @error('from_date')
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label>To :</label>
                                                <input name="to_date" type="date"  value="{{ old('to_date') }}" class="form-control" placeholder="No of Followup" required>
                                                @error('to_date')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <a href="{{route('telecaller.teleworkreport')}}" class="btn btn-danger">Reset</a>
                                        </div>
                                    </div>
