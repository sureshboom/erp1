                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            ...
                            <a href="{{ route('telecaller.customer.create')}}" class="btn btn-primary">+ Add New</a>
                            <!-- {{ $customers }} -->
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="datatable-ct"><i class="fa fa-check"></i>
                                                <a href="{{ route('telecaller.customer.edit', $customer->id) }}"
                                                ...
                                                <form method="post" action="{{ route('telecaller.customer.destroy', $customer->id) }}" id="delete-post-{{ $customer->id }}" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
