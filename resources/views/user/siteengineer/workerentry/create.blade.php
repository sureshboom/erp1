        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form action="{{ route('siteengineer.workerentry.store') }}" class="acount-infor" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <div class="col-lg-6 col-lg-offset-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="mesthiri_id" name="mesthiri_id" class="form-control">
                                @error('mesthiri_id')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label>Date</label>
                                <input type="date"  name="workeddate" class="form-control">
                                @error('workeddate')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
