                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="datatable-ct">
                                                @if($work->status != 'verified')
                                                <a href="{{ route('siteengineer.workentry.edit', $work->id) }}"
                                                ...
                                                <form method="post" action="{{ route('siteengineer.workentry.destroy', $work->id) }}" id="delete-post-{{ $work->id }}" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                @else
