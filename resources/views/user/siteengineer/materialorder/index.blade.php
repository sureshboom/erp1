                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            ...
                            <a href="{{ route('siteengineer.material_order.create')}}" class="btn btn-primary">+ Add New</a>
                            <!-- {{ $materials }} -->
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="datatable-ct"><i class="fa fa-check"></i>
                                                <a href="{{ route('siteengineer.supplier.edit', $material->id) }}"
                                                ...
                                                <form method="post" action="{{ route('siteengineer.supplier.destroy', $material->id) }}" id="delete-post-{{ $material->id }}" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
