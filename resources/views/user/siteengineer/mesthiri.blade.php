                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="action" data-editable="false">Phone No</th>
                                            <th data-field="sitetype">Location</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $site->mesthiri_id ? $site->mesthiri->sksmt_id : '-' }}</td>
                                            
                                            <td>{{ $site->mesthiri->name ? $site->mesthiri->name : '-' }}</td>
                                            <td>{{ $site->mesthiri->phone ? $site->mesthiri->phone : '-' }}</td>
                                            <td>{{ $site->mesthiri->location ? $site->mesthiri->location : '-' }}</td>
                                        </tr>
                                        @empty
                                        <tr>
                                            <td></td>
